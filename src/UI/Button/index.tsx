...
export type T_Props = ComponentProps<typeof motion.button> & {
...
export const Button = ({ children, variant = 'primary', size = 'middle', w = 'fit-content', className, style, ...props }: T_Props) => {
